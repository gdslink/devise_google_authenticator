  ...
  module CheckGA
    ...
    included do
      ...
      define_method :create do
        ...
        if resource.respond_to?(:get_qr) and ActiveModel::Type::Boolean.new.cast(resource.gauth_enabled) #Therefore we can quiz for a QR
        ...
        elsif resource.respond_to?(:get_qr) and !ActiveModel::Type::Boolean.new.cast(resource.gauth_enabled) and resource.gauth_secret
          #we head back into the checkga controller with the temporary id
